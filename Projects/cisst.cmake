...
set(EP_CMAKE_ARGS
  ...
  -DCISST_SVL_USE_USER_OPENCV:BOOL=${PROJECTS_OpenCV}
...
if(PROJECTS_OpenCV)
  list(APPEND EP_CMAKE_ARGS
    -DOpenCV_DIR:PATH=${PROJECT_BINARY_DIR}/OpenCV-build)
endif()
if(PROJECTS_SWIG)
  list(APPEND EP_CMAKE_ARGS
    ...
    -DSWIG_DIR:PATH=${CMA_SWIG_DIR}
    -DSWIG_EXECUTABLE:FILEPATH=${CMA_SWIG_EXECUTABLE}
    -DSWIG_VERSION:STRING=${CMA_SWIG_VERSION})
endif()
